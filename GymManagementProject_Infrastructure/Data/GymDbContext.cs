...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Member>(entity =>
        {
            ...
            entity
                .HasIndex(e => e.Status, "idx_members_active_status")
                .HasFilter("(((status)::text = 'active'::text) AND (deleted_at IS NULL))");
        ...
        modelBuilder.Entity<MemberProfile>(entity =>
        {
            ...
            entity.Property(e => e.DistrictHash).HasMaxLength(128).HasColumnName("district_hash");
            ...
            entity.Property(e => e.ProvinceHash).HasMaxLength(128).HasColumnName("province_hash");
            entity
                .Property(e => e.UpdatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnName("updated_at");
        ...
        modelBuilder.Entity<PtContract>(entity =>
        {
            ...
            entity
                .HasIndex(e => e.Status, "idx_pt_contracts_active")
        ...
        modelBuilder.Entity<RefreshToken>(entity =>
        {
            ...
            entity
                .HasIndex(e => e.UserId, "idx_refresh_tokens_user_id_used")
                .HasFilter("((is_used = false) AND (revoked_at IS NULL))");
            ...
            entity
                .HasOne(d => d.ReplacedByToken)
                .WithMany(p => p.InverseReplacedByToken)
        ...
        {
            entity.HasNoKey().ToView("revenue_summary", "sales");
        ...
        modelBuilder.Entity<UserProfile>(entity =>
        {
            ...
            entity.ToTable("user_profiles", "iam");

            entity.HasIndex(e => e.PhoneHash, "idx_user_profiles_phone_hash");

            entity.HasIndex(e => e.ProvinceHash, "idx_user_profiles_province");
            ...
            entity.Property(e => e.FullNameEnc).HasColumnName("full_name_enc");
            entity.Property(e => e.Gender).HasMaxLength(10).HasColumnName("gender");
            entity.Property(e => e.IdentityCardNoEnc).HasColumnName("identity_card_no_enc");
            entity.Property(e => e.PhoneEnc).HasColumnName("phone_enc");
            entity.Property(e => e.PhoneHash).HasMaxLength(128).HasColumnName("phone_hash");
            entity.Property(e => e.ProvinceEnc).HasColumnName("province_enc");
            entity.Property(e => e.ProvinceHash).HasMaxLength(128).HasColumnName("province_hash");
        ...
        foreach (var entry in ChangeTracker.Entries<ISoftDelete>())
        {
            switch (entry.State)
            {
                case EntityState.Deleted:
                    // CHẶN VIỆC XÓA THẬT: Chuyển từ Delete sang Update
